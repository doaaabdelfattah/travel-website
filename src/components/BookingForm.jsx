...
function BookingForm() {
  return (
    <>
      <div className="bg-[#F4F5F8] mx-auto">
        {/* Hero background image */}
        <div className="h-screen bg-cover bg-center bg-fixed w-[80%] mx-auto ">
          {/* Black overlay */}
          {/* <div className="absolute inset-0 bg-black opacity-30 z-10"></div> */}
          {/* Main header */}
          <div className="flex justify-center items-center absolute top-[150px] pt-[150px] z-50">
            <div className="w-full h-full text-4xl pt-5 absolute z-50 ">
              <h1 className="font-bold text-center">Book Appointment</h1>
            </div>
            <div className="Form-container z-50  p-10 flex flex-col lg:flex-row justify-between m-5 h-full space-y-5 lg:space-y-0">
              ...
              <div className="left-section flex flex-col justify-center items-start w-full lg:w-[40%] mt-4 lg:mt-0 space-y-5 order-2 lg:order-1">
                <div className="w-full">
                  <h1 className="font-bold text-5xl py-7 text-gray-800 text-center">
                    Experience the Adventure of a Lifetime
                  </h1>
                  <p className="text-center text-gray-500 text-md">
                    Book your adventure today and take the first step towards an
                  ...
                  <div className="form w-full">
                    <form className="grid grid-cols-2 gap-5">
                      <input
                        type="text"
                        placeholder="Name"
                        className="col-span-1 p-2 border border-gray-400 rounded-md"
                      />
                      <input
                        type="email"
                        placeholder="Email"
                      ...
                      <textarea
                        ...
                        className="col-span-2 p-2 border border-gray-400 rounded-md"
                      ></textarea>
                      <button
                        type="submit"
